 ...
 */
public class Canción extends ElementoConNombre implements ReproducirCancion {

    private String autor;//representa el nombre del autor de la canción
    private CategoríaMusical categoria;//enumeración que representa la categoróa a la que va a pertenecer.
     ...
     */
    public Canción(String nombre, String autor, CategoríaMusical categoria, String[] opcionesEleccion, short año, String disco, File imagen, String ruta, Clip audioClip) {
        super(nombre);
        this.autor = autor;
     ...
     */
    public CategoríaMusical getCategoria() {
        return categoria;
    }
     ...
     */
    public void setCategoria(CategoríaMusical categoria) {
        this.categoria = categoria;
    }
